...
public class GUI{
    ...
    public GUI(){
        model = new DefaultTableModel(new String[]{"Process", "TG xuat hien", "TG dung CPU", " ", "TD ket thuc su dung CPU", "TG luu lai", "TG cho"}, 0);
        ...
        option = new JComboBox(new String[]{"FCFS", "SJF", "SRTF", "RR"});
...
//        frame.setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\chrome downloads\\OperatingSystem\\src\\operatingsystem\\background.png"));
